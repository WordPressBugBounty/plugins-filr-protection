...
if ( !class_exists( 'FILR_Settings' ) ) {
    class FILR_Settings {
        ...
        public function plugin_page() {
            ...
            echo esc_url( FILR_URL ) . '/assets/filr-logo.svg';
            ?>" alt="filr-logo" /></div>
				<div class="info-links">
				<?php 
            ?>
					<a href="https://patrickposner.com/filr/" target="_blank">Go Pro</a>
					<a href="https://patrickposner.com/filr/docs/" target="_blank">Documentation</a>
