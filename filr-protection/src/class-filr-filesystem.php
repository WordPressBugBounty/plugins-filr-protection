...
class FILR_Filesystem {
    ...
    public function ajax_upload_file() {
        ...
        // Clean up file upload before saving meta.
        $cleaned_files = array();
        foreach ( $data['files'] as $file ) {
            $file['name'] = sanitize_file_name( $file['name'] );
            $file['title'] = sanitize_file_name( $file['title'] );
            $file['old_name'] = sanitize_file_name( $file['old_name'] );
            $file['old_title'] = sanitize_file_name( $file['old_title'] );
            $cleaned_files[] = $file;
        }
