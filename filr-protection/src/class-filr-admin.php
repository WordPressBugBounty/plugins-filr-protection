...
class FILR_Admin {
    ...
    public function register_filr() {
        ...
        $args = array(
            ...
            'capabilities'       => array(
                'edit_post'          => apply_filters( 'filr_manage_capability', 'manage_options' ),
                'read_post'          => apply_filters( 'filr_manage_capability', 'manage_options' ),
                'delete_post'        => apply_filters( 'filr_manage_capability', 'manage_options' ),
                'edit_posts'         => apply_filters( 'filr_manage_capability', 'manage_options' ),
                'edit_others_posts'  => apply_filters( 'filr_manage_capability', 'manage_options' ),
                'delete_posts'       => apply_filters( 'filr_manage_capability', 'manage_options' ),
                'publish_posts'      => apply_filters( 'filr_manage_capability', 'manage_options' ),
                'read_private_posts' => apply_filters( 'filr_manage_capability', 'manage_options' ),
            ),
            'has_archive'        => false,
            'hierarchical'       => false,
            'menu_position'      => 20,
